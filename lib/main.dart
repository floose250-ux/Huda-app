...
/// framework-level rebuild optimizations and allow 'const' usage.
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      shape: const RoundedRectangleBorder(
        // Using Radius.elliptical(x, x) as per optimization guidelines
        // to ensure a constant expression for the border radius.
...
class AzkarCategoriesPage extends StatelessWidget {
  /// Static constant list of categories to avoid redundant allocations on every build.
