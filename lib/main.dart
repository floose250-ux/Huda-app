...
class _HudaProHomeState extends State<HudaProHome> {
  ...
  Widget _buildIstighfarChallenge() => Container(
        margin: const EdgeInsets.all(20),
        padding: const EdgeInsets.all(25),
        decoration: BoxDecoration(
          gradient: LinearGradient(colors: [Colors.teal.shade900, Colors.teal.shade600]),
        ...
        child: Column(
          children: [
            ...
            Text('$_count', style: const TextStyle(color: Colors.white, fontSize: 50, fontWeight: FontWeight.bold)),
            const SizedBox(height: 10),
            ElevatedButton(
  ...
  Widget _card(String t, IconData i, Color c) => Card(
        ...
        child: Column(
          ...
          children: [Icon(i, size: 40, color: c), const SizedBox(height: 10), Text(t, style: const TextStyle(color: Colors.white))],
        ),
      );
}
