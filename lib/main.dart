...
/// Optimized: Extracted from a helper method to a standalone [StatelessWidget]
/// to enable [const] constructor optimizations, allowing Flutter to skip
/// rebuilds of these widgets.
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  /// Optimized: Moved categories to a static const member to avoid redundant
  /// memory allocations and CPU cycles on every widget rebuild.
