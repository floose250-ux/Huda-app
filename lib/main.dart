  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GridView.count(
        ...
        // Performance Optimization: Using 'const' with StatelessWidget enables
        // Flutter's framework-level rebuild optimizations.
        children: const [
...
/// Performance Optimization: Refactored from a helper method to a separate
/// StatelessWidget. This allows for better rebuild performance and enables
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  // Performance Optimization: Moved static data out of 'build' into 'static const'
  // to avoid redundant memory allocations and CPU cycles on every widget rebuild.
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) => Card(
          ...
          child: ListTile(
            leading: Icon(_categories[index]['icon'] as IconData, color: _categories[index]['color'] as Color),
            title: Text(_categories[index]['title'] as String, style: const TextStyle(color: Colors.white, fontSize: 18)),
