...
// Separate widget for Main Menu Cards to enable rebuild optimizations.
class MainMenuCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      // Optimization: use const BorderRadius.all for RoundedRectangleBorder
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  // Optimization: Moved categories to static const to avoid redundant allocations on every build.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) => AzkarCategoryTile(
...
// Separate widget for Azkar Category Tiles to enable rebuild optimizations.
