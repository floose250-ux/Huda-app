...
/// A custom card widget for the main categories on the home screen.
/// Refactored from a helper method to a [StatelessWidget] to enable 'const' optimizations.
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  /// Static constant list of categories to avoid redundant memory allocations on every rebuild.
...
/// A private widget for individual category items in [AzkarCategoriesPage].
/// Using a separate StatelessWidget allows for better framework-level rebuild optimizations.
