...
// Refactored helper method into a separate 'const' StatelessWidget to enable Flutter's rebuild optimizations.
class MainCategoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      // Using Radius.elliptical instead of Radius.circular to allow the constructor to be constant.
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  // Moved categories to a static const member to avoid redundant allocations on every build.
