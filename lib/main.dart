...
// Optimization: Refactored helper method into a const StatelessWidget to enable rebuild optimizations.
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  // Optimization: Move static data out of the build method to avoid redundant allocations.
