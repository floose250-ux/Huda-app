...
/// A custom widget for the main category cards to enable framework-level rebuild optimizations.
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  /// Static data moved out of build to avoid redundant allocations on every rebuild.
