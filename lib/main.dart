...
/// A card representing a main category on the home screen.
///
/// Optimization: Refactored from a helper method to a `const StatelessWidget`.
/// This allows the Flutter framework to use canonical instances and skip
/// rebuilding the widget tree when the parent's build method is called,
/// reducing CPU usage during re-renders.
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  /// Optimization: Hoisted categories list to a `static const` field.
  /// This prevents repeated memory allocations and object creation during
  /// every `build` call, reducing GC pressure and improving frame times.
