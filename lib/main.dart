...
/// A custom card for the main category grid.
/// Refactored into a [StatelessWidget] to enable 'const' optimizations and skip unnecessary rebuilds.
class MainCategoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      // Using Radius.elliptical(20, 20) instead of BorderRadius.circular(20)
      // to ensure it is a valid constant expression across all environments.
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  /// Static constant list of categories to avoid redundant memory allocations during build cycles.
