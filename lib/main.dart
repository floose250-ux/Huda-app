  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GridView.count(
        ...
        // Using const here ensures that these widgets are not rebuilt when HudaProHome is rebuilt.
        children: const [
...
/// Optimized custom card widget for the home screen grid.
/// Refactored from a helper method to a StatelessWidget to allow the framework
/// to optimize rebuilds and enable the use of 'const' constructors.
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  // Moved categories to static const to avoid redundant allocations on every build.
