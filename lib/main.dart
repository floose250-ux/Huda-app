  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GridView.count(
        ...
        crossAxisSpacing: 15,
        children: const [
          MainCategoryCard(title: 'المصحف الشريف', icon: Icons.menu_book, color: Color(0xFFFFA000)),
          MainCategoryCard(title: 'موسوعة الأذكار', icon: Icons.auto_awesome, color: Color(0xFFFF9800), page: AzkarCategoriesPage()),
...
class AzkarCategoriesPage extends StatelessWidget {
  static const List<Map<String, dynamic>> categories = [
    {'title': 'أذكار الصباح', 'icon': Icons.wb_sunny, 'color': Color(0xFFFF9800)},
