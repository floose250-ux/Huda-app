  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GridView.count(
        ...
        children: const [
          MainCard(
              title: 'المصحف الشريف', icon: Icons.menu_book, color: Colors.amber),
          MainCard(
...
// ⚡ Bolt Optimization: Refactored from a helper method to a const StatelessWidget.
// This enables Flutter framework-level rebuild optimizations, as const widgets
// are not rebuilt if their parameters haven't changed.
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  // ⚡ Bolt Optimization: Moved static data out of the build method into a static const member.
  // This avoids redundant memory allocations and CPU cycles on every widget rebuild,
