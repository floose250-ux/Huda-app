...
class HudaProHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('هدى برو - الموسوعة الشاملة'), backgroundColor: const Color(0xFF004D40), centerTitle: true),
      body: GridView.count(
        crossAxisCount: 2,
        ...
        children: const [
          ...
          MainCategoryCard(title: 'موسوعة الأذكار', icon: Icons.auto_awesome, color: Colors.orange, page: const AzkarCategoriesPage()),
...
class MainCategoryCard extends StatelessWidget {
  ...
  const MainCategoryCard({super.key, required this.title, required this.icon, required this.color, this.page});
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFF000D0D),
      appBar: AppBar(title: const Text('موسوعة الأذكار'), backgroundColor: const Color(0xFF004D40)),
