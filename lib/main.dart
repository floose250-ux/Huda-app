...
// Refactored from helper method to StatelessWidget to enable framework-level rebuild optimizations
// and support 'const' constructors for better performance.
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  // Moved to static const to avoid redundant memory allocations and CPU cycles on every rebuild.
