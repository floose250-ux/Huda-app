...
/// A custom card widget for main categories on the home screen.
/// Using a separate 'const' StatelessWidget instead of a helper method
/// enables Flutter's rebuild optimization and improves performance.
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      shape: const RoundedRectangleBorder(
        // Using Radius.elliptical(x, x) instead of Radius.circular(x)
        // to allow the border and card to be a constant expression.
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  /// Move static data out of 'build' into 'static const' to avoid
  /// redundant memory allocations and CPU cycles on every widget rebuild.
