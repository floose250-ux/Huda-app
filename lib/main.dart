...
/// A dedicated [StatelessWidget] for the main category cards.
/// Refactored from a helper method to a const class to optimize widget rebuilds.
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  /// Static constant list of categories to avoid re-allocation during builds.
