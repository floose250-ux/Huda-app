...
/// Refactored from helper method to a const StatelessWidget to enable
/// Flutter framework optimizations (rebuild avoidance).
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  /// Static const data to avoid redundant allocations on every build.
