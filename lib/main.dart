...
/// A standalone constant widget for the main menu items.
/// Refactoring from a helper method to a widget class improves performance
/// by allowing the Flutter framework to optimize rebuilds.
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  // Moving static data out of the build method to avoid redundant allocations.
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              ...
              title: Text(item['title'] as String, style: const TextStyle(color: Colors.white, fontSize: 18)),
