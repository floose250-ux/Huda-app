  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GridView.count(
        ...
        children: [
          const MainCategoryCard(title: 'المصحف الشريف', icon: Icons.menu_book, color: Colors.amber),
          const MainCategoryCard(title: 'موسوعة الأذكار', icon: Icons.auto_awesome, color: Colors.orange, page: AzkarCategoriesPage()),
          const MainCategoryCard(title: 'جوامع الدعاء', icon: Icons.favorite, color: Colors.redAccent),
          const MainCategoryCard(title: 'الموسوعة الحديثية', icon: Icons.history_edu, color: Colors.blueAccent),
        ],
      ),
    );
  }
