...
// Refactored helper method into a separate 'const' StatelessWidget for better performance
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  // Moved static data out of the 'build' method to avoid redundant allocations
