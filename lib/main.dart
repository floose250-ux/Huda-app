      ...
      body: GridView.count(
        ...
        children: const [
          ...
          MainCategoryCard(
            ...
            color: Colors.orange,
            targetPage: AzkarCategoriesPage(),
          ),
...
class MainCategoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      // Using elliptical to ensure constant expression across environments
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  // Moved to static const to avoid redundant allocations on every rebuild
