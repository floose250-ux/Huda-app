...
/// A dedicated widget for main category cards to optimize rebuilds.
/// Refactored from a helper method to a const StatelessWidget.
...
class AzkarCategoriesPage extends StatelessWidget {
  /// Static data moved out of the build method to avoid redundant allocations on every rebuild.
