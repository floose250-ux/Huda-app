...
// Refactored from helper method to const StatelessWidget to improve performance.
// This allows the Flutter framework to use canonical instances and optimize rebuilds.
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  // Moved to static const to prevent redundant memory allocations on every build call.
