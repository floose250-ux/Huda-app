...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  static const List<Map<String, dynamic>> _categories = [
    ...
    {'title': 'أدعية الأنبياء', 'icon': Icons.person, 'color': Color(0xFF4CAF50)}, // green
    {
    ...
    {'title': 'أدعية السفر', 'icon': Icons.flight, 'color': Color(0xFF9C27B0)}, // purple
  ];
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) => Card(
          ...
          child: ListTile(
            leading:
                Icon(_categories[index]['icon'], color: _categories[index]['color']),
