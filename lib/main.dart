...
/// A card widget representing a main category in the app.
/// Refactored from a helper method to a [StatelessWidget] to enable
/// framework-level rebuild optimizations using the const constructor.
class MainCategoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      // Optimization: Radius.elliptical is a constant expression, enabling const border.
...
class AzkarCategoriesPage extends StatelessWidget {
  /// Static constant data to avoid redundant allocations on every build.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) => AzkarCategoryCard(
...
/// A card widget for displaying an individual Azkar category.
/// Refactored into a const StatelessWidget to prevent unnecessary rebuilds.
