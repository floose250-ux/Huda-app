    ...
    return Scaffold(
      ...
      body: GridView.count(
        ...
        children: const [
          ...
          MainCategoryCard(
              title: 'جوامع الدعاء', icon: Icons.favorite, color: Colors.redAccent),
          MainCategoryCard(
...
class MainCategoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      // Using constant BorderRadius.all with Radius.elliptical instead of BorderRadius.circular
      // to ensure it is a valid constant expression across all Flutter versions.
