...
/// A custom card for the main menu, optimized as a const StatelessWidget
...
class MainMenuCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      // Using const BorderRadius for better performance
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  /// Static constant list of categories to avoid re-allocation on every build.
