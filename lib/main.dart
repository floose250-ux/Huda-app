...
/// Refactored helper method into a const StatelessWidget to enable framework-level optimizations.
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  // Moving static data out of build method to avoid redundant allocations.
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              ...
              title: Text(category['title'] as String, style: const TextStyle(color: Colors.white, fontSize: 18)),
