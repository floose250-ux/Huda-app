...
/// Refactored to a [StatelessWidget] to allow for `const` constructors and better performance.
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  /// This optimizes memory usage and performance by defining the data once.
