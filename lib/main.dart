...
class MainCategoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      // Using constant constructor for RoundedRectangleBorder to enable framework-level optimizations
...
class AzkarCategoriesPage extends StatelessWidget {
  ...
  // Moved static data out of the build method to avoid redundant allocations on every rebuild
