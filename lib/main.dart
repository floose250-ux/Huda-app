  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GridView.count(
        ...
        children: const [
          // BOLT OPTIMIZATION: Using const widgets allows the framework to skip rebuilding the subtree.
...
class AzkarCategoriesPage extends StatelessWidget {
  // BOLT OPTIMIZATION: Moving static data to a static const field prevents repeated allocations during build.
