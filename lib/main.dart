...
/// A optimized main category card widget.
/// Refactored from a helper method to a [StatelessWidget] to enable
/// framework-level rebuild optimizations and use of 'const' constructors.
class MainCategoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      // Using const BorderRadius.all for performance and to allow const constructor
