  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFF004D40), // Optimization: Using hex literal for const
        centerTitle: true,
      ),
      body: GridView.count(
        crossAxisCount: 2,
        ...
        children: const [
          ...
          MainCategoryCard(
            title: 'جوامع الدعاء',
            icon: Icons.favorite, // Bugfix: Corrected casing
            color: Color(0xFFFF5252),
          ),
          MainCategoryCard(
            title: 'الموسوعة الحديثية',
            icon: Icons.history_edu, // Bugfix: Corrected casing
...
// Optimization: Refactored helper method to a const StatelessWidget for better performance
...
class AzkarCategoriesPage extends StatelessWidget {
  // Optimization: Moved data structure to static const field to reduce memory allocation
